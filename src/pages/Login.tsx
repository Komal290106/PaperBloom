  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-100 to-pink-100 flex items-center justify-center px-4 py-12">
      <motion.div
        ...
        className="bg-white rounded-3xl border-2 border-pink-200 shadow-2xl p-8 w-full max-w-md"
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Login to continue folding</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 border-2 border-pink-200 rounded-xl focus:border-pink-400 focus:outline-none"
          ...
          <button
            type="submit"
            className="w-full py-3 bg-pink-500 text-white rounded-xl font-semibold hover:bg-pink-600 hover:shadow-lg transition-all duration-200 hover:-translate-y-1"
          >
            Login
          </button>
